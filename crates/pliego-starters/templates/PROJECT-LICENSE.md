# Choose your project's license

PliegoRS does not automatically license new application code, content, brand,
or original assets that you author after generation. Before distributing this
project:

1. choose a license appropriate for your application;
2. add its SPDX identifier to `Cargo.toml`;
3. replace this file with the complete license text; and
