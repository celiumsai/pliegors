...
| P8-A06 | Reproducible cold/warm/content/CSS/Rust-view/browser-apply/memory benchmarks | The [versioned P8 harness](39-reproducible-benchmarks.md), raw observations, nearest-rank summaries, schema, clean-tree guard, and honest scope contract are implemented; candidate evidence remains open | Clean same-revision build/browser reports merged and sealed with the candidate |
