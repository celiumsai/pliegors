...
**Status:** `0.4.0-beta.1` is the coordinated PliegoRS public beta. The
...
`pliego-ssg = { version = "=0.4.0-beta.1" }`. Every first-party crate in a project must
...
signed in `0.4.0-beta.1`. Those platforms are development surfaces; their archive
...
```sh
mkdir pliegors-v0.4.0-beta.1
cd pliegors-v0.4.0-beta.1
gh release download v0.4.0-beta.1 --repo celiumsai/pliegors
