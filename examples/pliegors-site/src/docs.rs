...
pub const TOPICS: &[DocTopic] = &[
    ...
    DocTopic {
        ...
        summary_en: "Evaluate the unreleased sealed router, route-owned layouts, bounded request lifecycle, authored errors, and three SSR modes from main.",
        summary_es: "Evalúa desde main el router sellado, layouts controlados por rutas, lifecycle limitado de requests, errores con autoría y tres modos SSR aún no liberados.",
    },
    DocTopic {
        slug: "opensdk",
        group_en: "OpenSDK",
    ...
    vec![
        doc_section(locale, "choose", "Choose the owning crate", "Elige el crate propietario", vec![
            definition_list(locale, &[
                ...
                ("pliego-router / pliego-runtime (unreleased)", "G1 sealed server routes, route-owned layouts, bounded HTTP lifecycle, middleware, failures, receipts, and three SSR modes", "Rutas de servidor selladas G1, layouts controlados por rutas, lifecycle HTTP limitado, middleware, fallos, recibos y tres modos SSR"),
        ...
        doc_section(locale, "symbols", "Core public entry points", "Entradas públicas principales", vec![
            definition_list(locale, &[
                ...
                ("pliego_runtime::{NativeRuntimeBuilder, LayoutDocument, BoundaryDocument}", "Evaluate route-owned documents, the unreleased G1 native lifecycle, and three SSR modes from main", "Evalúa documentos controlados por rutas, el lifecycle nativo G1 y sus tres modos SSR aún no liberados"),
