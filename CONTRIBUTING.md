...
it and agree that software contributions are licensed under AGPL-3.0-only and
project-authored documentation, graphics, diagrams, or original non-software
media contributions are licensed under CC-BY-SA-4.0, according to
`LICENSING.md` and file-level notices.
